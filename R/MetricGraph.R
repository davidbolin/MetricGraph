...
#' @export gg_df
#' @importFrom stats predict approx dist dnorm pnorm rnorm var as.formula delete.response model.matrix optim terms
...
#' @importFrom rgeos gProject gBuffer gDistance gInterpolate gIntersection gWithinDistance 
