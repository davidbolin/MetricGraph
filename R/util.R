...
#'
#' @examples
#' # Assuming 'graph' is a metric_graph object and 'data_on_mesh' is a data frame
#' # with '.edge_number' and '.distance_on_edge' columns
#' data_on_mesh_ordered <- match_mesh_data(graph, data_on_mesh)
#'
