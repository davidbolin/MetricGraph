...
We can directly plot from the mesh values. 
...
We will now plot this function with `plot_function`:
...
However, it is important to observe that `plot_function` assumes continuity of the function by default. Let us see an example of a discontinuous function.
...
We will now plot this function:
