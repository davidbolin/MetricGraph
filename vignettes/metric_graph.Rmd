...
However, it is important to observe that the argument `improve_plot` assumes continuity of the function. Let us see an example of a discontinuous function, and observe the effect of `improve_plot`: