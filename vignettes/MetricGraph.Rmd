...
Now, note that when creating the graph there was a warning saying that the graph is not connected, so let us create a 
...
graph$plot_function(X = mean_field_prd = TRUE,
...
graph$plot_function(X = mean_obs_prd = TRUE,
                    vertex_size = 0, edge_width = 0.5,
                    type = "mapview")
```
