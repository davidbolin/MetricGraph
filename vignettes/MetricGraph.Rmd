...
org/download/](http://R-INLA.org/download/) and `inlabru` [@inlabru2019](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/2041-210X.13168) that facilitates using those packages for full Bayesian inference of general Latent Gaussian Models (LGMs) that includes Whittle--Matérn fields on metric graphs. 
...
```{r, fig.show='hold',fig.align = "center",echo=TRUE}
C <- covariance_alpha1_mesh(c(200, 0.1), range = range, sigma = sigma, 
                            graph = graph)
