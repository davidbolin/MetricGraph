...
```{r, fig.align = "center",echo=TRUE, fig.height=7,fig.width=7, warning=FALSE}
...
```{r, message=FALSE, warning=FALSE, fig.align = "center",echo=TRUE, fig.height=7,fig.width=7}
p <- pems_graph$plot_function(
  newdata = pred_alpha1_bc, 
  data = ".fitted",
  improve_plot = TRUE, 
  vertex_size = 0,
  edge_width = 0.5, 
  type = "mapview", 
  mapview_caption = "Pred alpha1 bc"
)
...
pred_plot <- pred_plot %>% leaflet::fitBounds(
  lng1 = coordx_lwr2, lat1 = coordy_lwr2,  
  lng2 = coordx_upr2, lat2 = coordy_upr2
)
```
