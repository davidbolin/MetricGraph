...
graph$add_PtE_observations(y, PtE = obs_loc, normalized=TRUE)
...
graph$plot(data=TRUE, vertex_size = 0, data_size = 2, p = p, edge_width = 0)
```
...
```{r, fig.show='hold',fig.align = "center",echo=TRUE, fig.width=7, warning=FALSE}
graph_prd$add_PtE_observations(y, PtE = obs_loc, 
                            normalized=TRUE)
```
...
graph_prd$plot(data=TRUE, vertex_size = 0, data_size = 2, p = p, edge_width = 0)
```
...
```{r, fig.show='hold',fig.align = "center",fig.width=7,echo=TRUE}
graph_rep$add_PtE_observations(y_rep[,1], 
