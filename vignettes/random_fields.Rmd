...
sigma_e_est <- fit_repl_isoexp$coeff$measurement_error
sigma_est <- fit_repl_isoexp$coeff$random_effects[1]
kappa_est <- fit_repl_isoexp$coeff$random_effects[2]
...
Let us now plot the predictions of the first replicate:
