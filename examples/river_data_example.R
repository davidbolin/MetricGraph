...
res <- graph_lme(y ~ elev+slope, graph = graph, model = 'WM1')
res.cross <-posterior_crossvalidation(res)
res2 <- graph_lme(y ~ elev+slope, graph = graph, model = 'WM2',improve_hessian=T)
