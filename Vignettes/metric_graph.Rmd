...
vignette: >
  %\VignetteIndexEntry{Metric graphs}
...
In this vignette we will introduce the `metric_graph` class
...
graph4$plot(show = FALSE, marker_size = 0)
```
