...
- [Comparison of different models using real
  data](https://davidbolin.github.io/MetricGraph/articles/comparison.md):
- [An example with directional
  models](https://davidbolin.github.io/MetricGraph/articles/directional_model.md):
- [Whittle--Matérn fields with general
  smoothness](https://davidbolin.github.io/MetricGraph/articles/fem_models.md):
- [Working with disconnected metric
  graphs](https://davidbolin.github.io/MetricGraph/articles/graph_components.md):
- [INLA interface for Whittle--Matérn fields on metric
  graphs](https://davidbolin.github.io/MetricGraph/articles/inla_interface.md):
- [inlabru interface of Whittle--Matérn
  fields](https://davidbolin.github.io/MetricGraph/articles/inlabru_interface.md):
- [On isotropic covariances on metric graphs with non-Euclidean
  edges](https://davidbolin.github.io/MetricGraph/articles/isotropic_noneuclidean.md):
- [Data manipulation on metric
...
- [An example with multiple likelihoods in INLA and
  inlabru](https://davidbolin.github.io/MetricGraph/articles/multi_likelihood.md):
- [Solving PDEs on metric
...
- [An example with a river graph
  model](https://davidbolin.github.io/MetricGraph/articles/river_example.md):
- [Spatio-temporal Models on Compact Metric
  Graphs](https://davidbolin.github.io/MetricGraph/articles/spacetime.md):
